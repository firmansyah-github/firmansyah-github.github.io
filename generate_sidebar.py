...
ignore_dirs = {'.git', '.github', 'output', 'docs', 'factor.docs', 'factor.index', 'factor.docs.freemarker.xmind', 'factor.docs.eclipse.snippets', 'factor.docs.templates.editor'}
...
def generate_sidebar():
    with open('factor.docs/_sidebar.md', 'w') as f:
        ...
        f.write('* [Templates Editor Mastery](/factor.docs.templates.editor/README.md)\n\n')
