...
package com.example.app.model.entity.paymentapplicationtransaction;
...
@Entity
@Table(name = "PaymentApplicationTransaction")
public class Paymentapplicationtransaction implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name="paymentBatchId", referencedColumnName="paymentBatchId", name="FK_Transaction_Payment")
    private Payment payment;
    @ManyToOne
    @JoinColumn(name="paymentApplicationQuoteId", referencedColumnName="paymentApplicationQuoteId", name="FK_Transaction_Quote")
    private Paymentapplicationquote paymentapplicationquote;
    @ManyToOne
    @JoinColumn(name="applicationId", referencedColumnName="applicationId", name="FK_Transaction_Quote")
    private Paymentapplicationquote paymentapplicationquote;
